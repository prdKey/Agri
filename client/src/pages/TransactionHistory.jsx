...
const CONTRACTS = [
  { address: "0xeD1F9FdEA9497E7f4F93342A59Aa0FeC70ce3894", name: "AGT Token",       color: "bg-yellow-100 text-yellow-800 border-yellow-200" },
  { address: "0x2fA0bC60946F01d8263B53226c588BEcaD54ff34", name: "Order Manager",   color: "bg-blue-100 text-blue-800 border-blue-200"       },
  { address: "0x61bf1689637C689d8Dc0046a77481f74B4373b92", name: "Product Manager", color: "bg-purple-100 text-purple-800 border-purple-200"  },
];
