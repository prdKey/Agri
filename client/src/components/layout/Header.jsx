                ...
                <div className="absolute top-9 left-0 w-full bg-green-700 z-50 border-t border-green-500 shadow-lg">
                  <div className="flex flex-col py-1">
                    <button onClick={() => { handleSellerClick(); setMobileMenuOpen(false); }}
                      className="flex items-center gap-2 px-4 py-2.5 text-white text-sm hover:bg-green-600 transition-colors">
          ...
          <div className="flex items-center gap-3">
            {!isPanelPage && (
              <button onClick={() => navigate("/transaction-history")}
                className="hidden sm:flex items-center gap-1 text-white text-xs hover:text-green-200 transition-colors">
            ...
            <button onClick={() => navigate("/about")} className="text-white hover:text-green-200 transition-colors">
      ...
      <div className="max-w-7xl mx-auto px-3 py-2.5 flex items-center gap-3">
        {isPanelPage ? (
          ...
          <button onClick={() => navigate("/")} className="flex items-center gap-2 flex-shrink-0 group">
            <img className="w-8 h-8 object-contain" src="/icon/AgritrustIcon.png" alt="AgriTrust" />
