  ...
  return (
    <>
      ...
      `}>
        ...
        <div className="flex flex-col gap-1 flex-1">
          {menuItems.map((item) => (
            <button
              ...
              className={`flex items-center gap-2.5 px-3 py-2.5 rounded-xl w-full text-left transition-colors duration-200 font-medium text-sm
                ${active === item.path
        ...
        <button
          onClick={logout}
          className="mt-4 flex items-center gap-2.5 px-3 py-2.5 rounded-xl w-full text-left bg-red-50 hover:bg-red-100 text-red-500 font-semibold text-sm transition-colors">
